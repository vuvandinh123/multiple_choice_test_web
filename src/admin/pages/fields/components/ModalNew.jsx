...
import { createField } from "../../../../service/formService";
import { checkWhitespace } from "../../../../utils";
...
const ModalNew = ({ setLoading }) => {
  const [item, setItem] = useState(FileData);
  ...
  const handleSubmit = async (e) => {
    ...
    const editApi = async () => {
      try {
        const res = await createField(item);
        if (res) {
          ...
          >
            <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
              ...
              <select
                ...
                id=""
              >
                <option className="capitalize" value="text">
                  text
                </option>
                <option className="capitalize" value="number">
                  number
                </option>
                <option className="capitalize" value="email">
                  email
                </option>
                <option className="capitalize" value="date">
                  date
                </option>
              </select>
                ...
                <div className="relative mb-5 mt-0">
                  ...
                  >
                    <input
                      type="checkbox"
                      onChange={(e) =>
                        setItem({ ...item, is_unique: e.target.checked })
                      }
                      value={item.is_unique}
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        if (e.target.checked) {
                          ...
                          setItem({ ...item, is_validate: false });
                        }
                      }}
