...
import { deleteFieldById, getAllFormField } from "../../../service/formService";
import ModalNew from "./components/ModalNew";
...
const ListField = () => {
  ...
  useEffect(() => {
    const fetchApi = async () => {
      try {
        const res = await getAllFormField(filter);
  ...
  const handleDelete = async (id) => {
    ...
    setLoading(true);
    const res = await deleteFieldById(id);
    if (res.status === 200) {
    ...
    <div>
      ...
      <div className="bg-white rounded-lg p-5 flex justify-between items-center">
        <div className="flex gap-2 items-center">
          <h3 className="text-lg">Danh sách các trường</h3>
        ...
        <div className="flex justify-center gap-2 items-center">
          <div>
            ...
            >
              ...
              <option value="0">Không hoat động</option>
            </select>
          </div>
